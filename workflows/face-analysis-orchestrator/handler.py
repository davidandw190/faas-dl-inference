...
def process_image(image_data: bytes) -> Dict[str, Any]:
    ...
    try:
        ...
        _, encoded_image = cv2.imencode('.jpg', orig_image)
...
def face_analysis_workflow(image_data: bytes) -> Dict[str, Any]:
    ...
    face_detection_result = call_function("face-detection", processed_image)
    ...
    gender_detection_result = call_function("face-gender-detection", face_detection_result)
    
    emotion_detection_result = call_function("face-emotion-detection", face_detection_result)
